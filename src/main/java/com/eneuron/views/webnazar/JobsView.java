...
@PageTitle("WEB NAZAR - Jobs & Interview")
@Route(value = "jobs-interview", layout = MainLayout.class)
@CssImport(value = "./themes/webnazar/home.css", themeFor="vaadin-text-field")
public class JobsView extends VerticalLayout implements AfterNavigationObserver {
...
UI.getCurrent().getPage().addJavaScript("https://www.googletagmanager.com/gtag/js?id=UA-80976618-1", LoadMode.LAZY);
	...
	private void generateWhatsNewOnWeb() {
		...
		Timeline timeline = Timeline.list("1554685648291762176").withHashtag("webnazar").withRelated("webnazar");
