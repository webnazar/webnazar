...
@PageTitle("WEB NAZAR - Science")
@Route(value = "science", layout = MainLayout.class)
@CssImport(value = "./themes/webnazar/home.css", themeFor="vaadin-text-field")
public class ScienceView extends VerticalLayout implements AfterNavigationObserver {
...
UI.getCurrent().getPage().addJavaScript("https://www.googletagmanager.com/gtag/js?id=UA-80976618-1", LoadMode.LAZY);
	...
	private void generateWhatsNewOnWeb() {
		...
		Timeline timeline = Timeline.list("1554091729741299712").withHashtag("webnazar").withRelated("webnazar");
