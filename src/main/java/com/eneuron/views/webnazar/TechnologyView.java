...
@PageTitle("WEB NAZAR - Technology")
@Route(value = "technology", layout = MainLayout.class)
@CssImport(value = "./themes/webnazar/home.css", themeFor="vaadin-text-field")
public class TechnologyView extends VerticalLayout implements AfterNavigationObserver {
...
UI.getCurrent().getPage().addJavaScript("https://www.googletagmanager.com/gtag/js?id=UA-80976618-1", LoadMode.LAZY);
	...
	private void generateWhatsNewOnWeb() {
		...
		Timeline timeline = Timeline.list("1554308912475942912").withHashtag("webnazar").withRelated("webnazar");
