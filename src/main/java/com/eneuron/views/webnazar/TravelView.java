...
public class TravelView extends VerticalLayout implements AfterNavigationObserver {
	...
	private void generateWhatsNewOnWeb() {
		...
		Timeline timeline = Timeline.list("1554095095695429634").withHashtag("webnazar").withRelated("webnazar");
