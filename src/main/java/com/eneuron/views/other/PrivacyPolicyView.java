...
public class PrivacyPolicyView extends VerticalLayout implements AfterNavigationObserver{
    ...
    private Component createPrivacyPolicy() {
    	...
    	Html html = new Html("<span>"
    			...
    			+ "<p>Welcome to <b> WebNazar</b>.</p>"
    			+ "<p><b>WebNazar</b> (“us”, “we”, or “our”) operates <b>webnazar.com</b> (hereinafter referred to as <b>“Service”</b>).</p>"
    			+ "<p>Our Privacy Policy governs your visit to <b>webnazar.com</b>, and explains how we collect, safeguard and disclose information that results from your use of our Service.</p>"
    			...
    			+ "<p><b>SERVICE</b> means the webnazar.com website operated by WebNazar.</p>"
    			...
    			+ "<p>WebNazar uses the collected data for various purposes:</p>"
    			...
    			+ "<p>If you are located outside Global and choose to provide information to us, please note that we transfer the data, including Personal Data, to Global and process it there.</p>"
    			+ "<p>Your consent to this Privacy Policy followed by your submission of such information represents your agreement to that transfer.</p>"
    			+ "<p>WebNazar will take all the steps reasonably necessary to ensure that your data is treated securely and in accordance with this Privacy Policy and no transfer of your Personal Data will take place to an organisation or a country unless there are adequate controls in place including the security of your data and other personal information.</p>"
    			...
    			+ "<p> If you wish to be informed what Personal Data we hold about you and if you want it to be removed from our systems, please email us at <b>webnazar@gmail.com</b>.</p>"
    			...
    			+ "<p>0.4. users are able to change their personal information by emailing us at <b>webnazar@gmail.com</b>.</p>"
    			...
    			+ "<p>To exercise your California data protection rights described above, please send your request(s) by email: <b>webnazar@gmail.com</b>.</p>"
    			...
    			+ "<p>If you have any questions about this Privacy Policy, please contact us by email: <b>webnazar@gmail.com</b>.</p>"
    			+ "<p style=\"margin-top: 5em; font-size: 0.7em;\">This <a href=\"https://policymaker.io/privacy-policy/\">Privacy Policy</a> was created for <b>webnazar.com</b> by <a href=\"https://policymaker.io\">PolicyMaker.io</a> on 2022-08-01.</p>"
    			+ "</span>");
