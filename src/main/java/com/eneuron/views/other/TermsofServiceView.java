package com.eneuron.views.other;
...
public class TermsofServiceView extends VerticalLayout implements AfterNavigationObserver{
 ...
 private Component createTermsofService() {
    	
    	
    	Html html = new Html("<span><h2  style=\"text-align: center;\">Terms and Conditions</h2>"
    			...
    			+ "</li>"
    			+ "<li>"
    			+ "<p><strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot; or &quot;Our&quot; in this Agreement) refers to WebNazar, #3, First Floor, Shama Complex, Old Agra Road, Malegaon.</p>"
    			+ "</li>"
    			+ "<li>"
    			...
    			+ "</li>"
    			+ "<li>"
    			+ "<p><strong>Website</strong> refers to WebNazar, accessible from <a href=\"http://www.webnazar.com\" rel=\"external nofollow noopener\" target=\"_blank\">http://www.webnazar.com</a></p>"
    			+ "</li>"
    			+ "<li>"
    			...
    			+ "<ul>"
    			+ "<li>By email: webnazar@gmail.com</li>"
    			+ "</ul>"
    			+ "</span>");
